...
1. **Layer Normalization** first (unlike the original "Attention is All You Need" which did it after—GPT-3 switched to pre-norm and never looked back)
...
- [Attention Is All You Need](https://arxiv.org/abs/1706.03762) - The foundational paper that started it all—read this to understand the full encoder-decoder architecture that GPT simplified
